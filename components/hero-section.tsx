...
export function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="
        relative overflow-hidden bg-[linear-gradient(189deg,_#ffffff_0%,_#d6fff7_50%,_#ffffff_100%)]
        px-4 pt-28 pb-14
        sm:px-6
        sm:pt-32 sm:pb-20
        md:pt-36 md:pb-24
    ...
    >
      ...
      <div className="mx-auto max-w-4xl relative z-10">
        <div className="text-center animate-fade-in-up space-y-0.5 my-[-39px]">
          <h1
            id="hero-heading"
            className="font-bold tracking-tight text-foreground text-balance text-4xl sm:text-4xl md:text-5xl lg:text-6xl my-5"
          >
